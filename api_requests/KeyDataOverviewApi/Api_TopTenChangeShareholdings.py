...
def Api_TopTenChangeShareholdings(currentTime, contrastTime, top_type, accountPassword):
    """
    股东分析: 性质分析
    股东变化：分组变化
    :param currentTime:
    ...
    :return:
    """
    url = "https://testserver.comein.cn/comein/irmcenter/irm/shareholder/home/change"
...
if __name__ == '__main__':
    list_data = Api_TopTenChangeShareholdings("2023-11-28", "2023-11-20", 0, [])
    print(list_data)
